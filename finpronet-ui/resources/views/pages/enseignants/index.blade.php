...
<main class="main-content">
    <header class="topbar">
      <div class="page-title-wrap">
        ...
        <span class="title-icon" aria-hidden="true"><i class="fa-solid fa-chalkboard-user"></i></span>
        <div>
          <h1>Dashboard Enseignant</h1>
          <p>Administration &gt; Enseignants &gt; Dashboard</p>
        </div>
      </div>
      <div class="search-wrap">
        <label class="sr-only" for="teacherSearch">Rechercher un enseignant</label>
        <input class="search-input" id="teacherSearch" type="search" placeholder="Rechercher un enseignant..." data-table-filter="#teacherTable">
      </div>
    </header>
