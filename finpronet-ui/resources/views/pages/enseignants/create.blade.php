    ...
    <header class="topbar">
      <div class="page-title-wrap">
        ...
        <div>
          ...
          <p>Administration &gt; Enseignants &gt; Creation</p>
        </div>
      </div>
      <div class="search-wrap">
        <label class="sr-only" for="teacherQuickSearch">Recherche</label>
        <input class="search-input" id="teacherQuickSearch" type="search" placeholder="Rechercher...">
      </div>
    </header>
