...
return new class extends Migration
{
    public function up(): void
    {
        if (Schema::hasTable('roles')) {
            DB::statement("ALTER TABLE `roles` MODIFY `niveau` ENUM('systeme','admin_metier','gestionnaire','admin','gestion','consultation','enseignant') NOT NULL DEFAULT 'consultation'");
            ...
            DB::statement("UPDATE `roles` SET `niveau` = 'consultation' WHERE `niveau` = 'enseignant'");
    ...
    {
        if (Schema::hasTable('roles')) {
            DB::statement("ALTER TABLE `roles` MODIFY `niveau` ENUM('systeme','admin_metier','gestionnaire','admin','gestion','consultation') NOT NULL DEFAULT 'consultation'");
